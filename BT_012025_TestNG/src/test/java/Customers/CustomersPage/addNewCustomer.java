...
public class addNewCustomer extends BaseTest {
    ...
    public void checkDataCustomerDetails() throws InterruptedException {
        ...
        Assert.assertEquals(valueCompany, company);
        Assert.assertEquals(valueVATnumber, VATnumber);
        Assert.assertEquals(valuePhoneNumber, phoneNumber);
        Assert.assertEquals(valueWebsite, website);
        Assert.assertEquals(valueGroup, group);
        Assert.assertEquals(valueCurrency, currency.replace("$", ""));
        Assert.assertEquals(valueLanguage, language);
        Assert.assertEquals(valueAddress, address);
        Assert.assertEquals(valueCity, city);
        Assert.assertEquals(valueState, state);
        Assert.assertEquals(valueZipcode, zipcode);
        Assert.assertEquals(valueCountry, country);
    }
